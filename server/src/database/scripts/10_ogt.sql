...
WHERE
    ...
    CREATE PROCEDURE GetogtApplicantDetailsInDetail(IN applicant_id INT)
BEGIN
    SELECT 
        status,
        firstName,
...
CREATE PROCEDURE ogtApplicantDetailsInBrief(IN applicant_id INT)
BEGIN
    SELECT 
        o.id,
        o.firstName,
...
CREATE VIEW ogtApplicationMaster AS
SELECT 
    /* application details */
    a.firstName,
    a.lastName
